    ...
    chats = {
        "jingyuan": [
            ...
            //     functimeout: 5000
                ...
                showif: "x1-1",
                type: "callfunc",
                funcname: `changeRejectedToTrue`
            }, {
                showif: "checkvar:rejected:yes",
                type: "text",
                dir: "in",
                content: `got rejected`
            }, {
                showif: "checkvar:rejected:no",
                type: "text",
                dir: "in",
                content: `didn't get rejected`
            }
...
function appendChatHistory(index) {
    ...
    if (choiceSelected) {
        if (chat.showif) {
            console.log({chat}, {choiceSelected})
            ...
            } else if (chat.showif.includes("checkvar:")) { // checkvar:[varname]:[value] // e.g. checkvar:rejected:true
                let variableName = chat.showif.split(":")[1];
                let variableValue = chat.showif.split(":")[2];

                if (checkVar[variableName] !== variableValue) {
                    return { command, timeoutMs };
                }
    ...
    switch (chat.type) {
        ...
        case "callfunc":
            ...
            } else if (chat.funcname === "changeRejectedToTrue") {
                checkVar.rejected = "yes";
